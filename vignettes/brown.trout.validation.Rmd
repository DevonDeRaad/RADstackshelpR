...
```{r}
knitr::include_graphics("/Users/devder/Desktop/Screen Shot 2021-08-16 at 10.26.29 AM.png")
```
...
```{r}
knitr::include_graphics(system.file("articles","brown.trout.validation_files", "trt.bigM.png", package="RADstackshelpR",mustWork=TRUE))
```
