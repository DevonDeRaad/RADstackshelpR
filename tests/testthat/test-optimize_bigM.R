...
test_that("optimize_bigM generates output of the appropriate class (list)", {
  ...
  opt.m<- optimize_bigM(M1 = system.file("extdata", "populations.snps.vcf.gz", package = "RADstackshelpR"))
...
test_that("optimize_bigM generates dataframes with appropriate dimensions when all slots are filled", {
  #find data in package using CRAN friendly syntax
  opt.m<- optimize_bigM(M1 = system.file("extdata", "populations.snps.vcf.gz", package = "RADstackshelpR"),
                     M2 = system.file("extdata", "populations.snps.vcf.gz", package = "RADstackshelpR"),
                     M3 = system.file("extdata", "populations.snps.vcf.gz", package = "RADstackshelpR"),
                     ...
                     M8 = system.file("extdata", "populations.snps.vcf.gz", package = "RADstackshelpR"))
